label chapter22:
    ...
    menu:
        ...
        "Natsuki, shoot the guard. If we try to go around him, he might shoot at us or warn the others that intruders are coming." if not ch22_libitina_has_gun():
            ...
            play sound gunshot1
            n "Aah!"
            "I scream in reaction to the noise, and the recoil I didn't anticipate..."
            "I dropped the gun, and my wrist is hurt."
            "My ears feel like they exploded!"
            "Albert mouths something, but I can't even hear him."
            "He shifts the gear to reverse and starts backing up."
            if persistent.threaten_libitina_to_come:
                "Libitina puts a hand on my shoulder and shows me a thumbs up."
